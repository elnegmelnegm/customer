...
st.markdown('''
  يعتمد التطبيق على الذكاء الاصطناعي والتعلم الآلي، حيث تم تدريبه على مجموعة بيانات ضخمة ، وذلك بهدف تقديم معلومات طبية دقيقة ومحدثة. ومع ذلك، من المهم الإشارة إلى أن التطبيق لا يغني عن استشارة الطبيب المختص في جميع الحالات ''', unsafe_allow_html=True)
